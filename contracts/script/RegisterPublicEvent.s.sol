...
contract RegisterPublicEventScript is Script {
    ...
    function run() external {
        ...
        string memory name = "Onchain POAP Tester";
        string memory description = "Onchain POAP for testers of OnchainPOAPs";
